...
photologo = 'https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg' #https://i.ibb.co/v6Vr7HCt/1000003297.png
photoyt = 'https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg' #https://i.ibb.co/v6Vr7HCt/1000003297.png
photocp = 'https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg'
photozip = 'https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/MICHAELXCLARKE")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/MICHAELXCLARKE")        ],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg",
    "https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg",
    "https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg",
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    photo=photologo,
                    caption="**Mʏ Nᴀᴍᴇ [𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋](https://t.me/MARCOXCHAT_BOT)\n\nYᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ\nCᴏɴᴛᴀᴄᴛ [𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋](https://t.me/MICHAELXCLARKE) ғᴏʀ ᴀᴄᴄᴇꜱꜱ**",
                    reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋", url="https://t.me/MICHAELXCLARKE")
    ],
    [
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        "<b>Mʏ Nᴀᴍᴇ [𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋🪷](https://t.me/MICHAELXCLARKE)</b>\n\n"
        "<blockquote>You need to have an active subscription to use this bot.\n"
        "Please contact admin to get premium access.</blockquote>",
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/MICHAELXCLARKE")
        ]])
    )
...
async def txt_handler(bot: Client, m: Message):  
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                cc = (
    f"<b>𝐓𝐈𝐓𝐋𝐄 ➔<b> {name}\n\n<b>𝐁𝐀𝐓𝐂𝐇 ➔<b> {b_name}\n\n<b>𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➔<b> @MICHAELXCLARKE\n"
)
                cc1 = (
    f"<b>𝐓𝐈𝐓𝐋𝐄 ➔<b> {name}\n\n<b>𝐁𝐀𝐓𝐂𝐇 ➔<b> {b_name}\n\n<b>𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➔<b> @MICHAELXCLARKE\n"
)
...
async def details_callback(client, callback_query: CallbackQuery):
    ...
    details_text = (
        "**📋 Bot Details 📋**\n\n"
        "• 🤖 Bot Name: 𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋 🪷\n"
        "• 👨‍💻 Developer: 𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋\n"
        "• 📱 Contact: @MICHAELXCLARKE\n"
        "• 🔄 Version: 1.0\n"
        "• 📝 Language: Python\n"
