...
CREDIT = os.environ.get("CREDIT", "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋")
...
THUMBNAILS = list(map(str, os.environ.get("THUMBNAILS", "https://i.ibb.co/WvvYDZkK/5afec16d5b7e.jpg").split())) # Image Link For Default Thumbnail 
